...
impl<L, C: Clone + PartialEq, S: Sort, F: Function> From<Located<syntax::Error>>
	for Error<L, C, S, F>
{
...
impl<L: fmt::Display, C: Clone + PartialEq, S: Sort + fmt::Display, F: Function + fmt::Display>
	fmt::Display for Error<L, C, S, F>
{
...
impl<L, C: Clone + PartialEq, F: Function> From<Located<crate::error::Error<Internal<L, C, F>>>>
	for InternalError<L, C, F>
{
